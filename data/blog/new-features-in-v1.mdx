...
**Eat Candy!** is a game where users attempt to eat as much falling candy from the screen as possible. The game uses facial landmark detection to detect the mouth and
determine if a candy was "eaten" before it falls off the screen.
